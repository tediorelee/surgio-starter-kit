http:
  ...
  mitm:
    ...
    - "a.qiumibao.com"
    - "a.wkanx.com"
    - "aarkissltrial.secure2.footprint.net"
    - "acs.m.taobao.com"
    - "act.vip.iqiyi.com"
    ...
    - "channel.beitaichufang.com"
    - "chelaile.net.cn"
    - "cheyouapi.ycapp.yiche.com"
    - "classbox2.kechenggezi.com"
    - "client.mail.163.com"
    - "client.qunar.com"
    ...
    - "fm.fenqile.com"
    - "foodie-api.yiruikecorp.com"
    - "free.sinaimg.cn"
    - "fuss10.elemecdn.com"
    - "g.cdn.pengpengla.com"
    - "g.tbcdn.cn"
    - "g1.163.com"
    - "games.mobileapi.hupu.com"
    - "gateway.shouqiev.com"
    - "gateway.shouqiev.com:0"
    - "gfp.veta.naver.com"
    - "ggic.cmvideo.cn"
    - "ggv.cmvideo.cn"
    - "ggw.cmvideo.cn"
    ...
    - "nochange.ggsafe.com"
    - "notch.qdaily.com"
    - "notice.send-anywhere.com"
    - "offline.microsofttranslator.com"
    - "oimage*.ydstatic.com"
    - "open.qyer.com"
    - "optimus-ads.amap.com"
    - "oral.youdao.com"
    - "oset-api.open-adx.com"
    - "overseas.weico.cc"
    - "p*.meituan.net"
    - "p.doras.api.vcinema.cn"
    - "p.du.163.com"
    - "p.kuaidi100.com"
    ...
    - "pic1cdn.cmbchina.com"
    - "pic?.ajkimg.com"
    - "player.hoge.cn"
    - "pocketuni.net"
    - "portal-xunyou.qingcdn.com"
    - "premiumyva.appspot.com"
    - "prom.mobile.gome.com.cn"
    - "promo.xueqiu.com"
    - "pss.txffp.com"
    - "pstatp.com"
    - "ptmpcap.caocaokeji.cn"
    - "qidian.qpic.cn"
    - "qt.qq.com"
    - "qzonestyle.gtimg.cn"
    - "r.inews.qq.com"
    ...
    - "r1.ykimg.com"
    - "render.alipay.com"
    - "res-release.wuta-cam.com"
    - "res.kfc.com.cn"
    - "res.mall.10010.cn"
    - "res.xiaojukeji.com"
    - "resrelease.wuta-cam.com"
    - "ress.dxpmedia.com"
    - "restapi.iyunmai.com"
    - "rich.kuwo.cn"
    ...
    - "saxw.sina.com.cn"
    - "sdk.99shiji.com"
    - "server-w.imrworldwide.com"
    - "service.4gtv.tv"
    - "service.iciba.com"
    - "sf*ttcdn-tos.pstatp.com"
    - "sh-gateway.shihuo.cn"
    - "shimo.im"
    - "shopic.sf-express.com"
    - "show.api.moji.com"
    - "shp.qpic.cn"
    - "simg.s.weibo.com"
    - "sina.com"
    ...
    - "tb2.bdstatic.com"
    - "thor.weidian.com"
    - "tiasdk.app.wechat.com"
    - "tiku.zhan.com"
    - "tj.playcvn.com"
    - "tracker-download.oss-cn-beijing.aliyuncs.com"
    ...
    - "w.gdt.qq.com"
    - "w.jstucdn.com"
    - "w.up.qingdaonews.com"
    - "w.ximalaya.com"
    - "wap.js.10086.cn"
    - "wap.ngchina.cn"
    - "web.chelaile.net.cn"
    - "webboot.zhangyue.com"
    - "weibointl.api.weibo.cn"
    - "weicoapi.weico.cc"
    - "werewolf.53site.com"
    - "wmapi.meituan.com"
    ...
    - "xyz.cnki.net"
    - "y.gtimg.cn"
    - "yxyapi*.drcuiyutao.com"
    - "zjh5api.189smarthome.com"
    - "zt-app.go189.cn"
  rewrite:
    ...
    - ^https?:\/\/p[^124](c)?\.music\.126\.net\/\w+==\/10995\d{13}\.jpg$ - reject
